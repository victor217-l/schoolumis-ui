...
class _LoginLecturerState extends State<LoginLecturer> {
  ...
  final loginSLecture = GlobalKey<FormState>();
  ...
  void loginlect() {
    lectureService.LoginLecture(context: context,
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          ...
                          onPressed: () async {
                            ...
                            if(loginSLecture.currentState!.validate()){
                              loginlect();
                            }
...
Widget greenIntroWidgetWithoutLogos({String title = "Login Lecturer",String? subtitle}){
  return Container(
    width: Get.width,
