...
class LoginWorship extends StatefulWidget {
  const LoginWorship({Key? key}) : super(key: key);

  @override
  State<LoginWorship> createState() => _LoginWorshipState();
}

class _LoginWorshipState extends State<LoginWorship> {
  ...
  final loginworship = GlobalKey<FormState>();
  ...
  void loginin() {
    worshipCentress.Logincentre(context: context, email: _emailController.text, password: _passwordController.text);
  }
